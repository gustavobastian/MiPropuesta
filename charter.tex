...
\begin{itemize}
	...
	\item Desarrollo local de una aplicacion cliente sistema 
...
\begin{enumerate}
	\item Requerimientos funcionales
		\begin{enumerate}
			...
			\item La aplicación móvil sistema debe mostrar las habitaciones sin atención,  según una tabla de prioridades(por ejemplo, si el mensaje es de algun dispositivo de urgencia-media), y en caso de igualdad de prioridades, la primera habitación que llamó.
			\item El usuario médico y el usuario enfermera deben poder enviar mensajes de textos o sonido comprimido en 32kbps(mp3).
			\item La página web de configuracion debe poder imprimir reportes de tareas realizadas filtrado por paciente, fecha, horario, enfermera.
	...
	\item Requerimientos de documentación
		\begin{enumerate}
			...
			\item Información sobre el broker MQTT 
		\end{enumerate}
	\item El sistema se debe testear con 10 habitaciones, 20 pacientes, 15 enfermeras y médicos simulados.
	\item Requerimientos de la interfaz:
	Aplicación Enfermera:
