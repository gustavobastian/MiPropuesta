...
\item Req 1.2: el servidor debe tener endpoints para interactuar con una aplicación Web, para consultas y envío de datos hacia dispositivos clientes.
	\begin{itemize}
	\item Verificación: se verificará que el servidor responda correctamente a solicitudes desde una aplicación especialmente desarrollada para ensayos de test.
	\item Validación: se comprobará correcto funcionamiento en la pagina web desarrollada.
	\end{itemize}

\item Req 1.3: el servidor debe tener endpoints para interactuar con la base de datos.
	\begin{itemize}
	\item Verificación: se verificará la presencia de las funciones CRUD a la base de datos, y se realizarán test unitarios en las distintas funciones. 
	\item Validación: se validará que las funciones respondan a las aplicaciones correctamente.
	\end{itemize}
...
\item Req 2.3: la base de datos a utilizar debe poseer las siguientes tablas:
			\begin{itemize}
				\item[]
				\begin{itemize}
					\item Habitaciones
...
\item Req 3.1: la página web debe ser cliente del broker MQTT.
	\begin{itemize}
	\item Verificación: se verificará que se utilice un broker MOSQUITTO MQTT.
	\item Validación:  no aplica.
	\end{itemize}
...
\item Req 3.3: la página web debe ser permitir visualización de estadísticas de pacientes o enfermeras. 
	...
	\item Validación:  se validará que se pueda visualizar estadísticas de las enfermeras y de los pacientes.
	\end{itemize}	
...
\item Req 4.3: la aplicación en modo enfermera debe permitir leer códigos QR.
	...
	\item Validación:  se realiza la acción en dispositivos de colaboradores en un entorno real de uso.
	\end{itemize}		
...
\item Req 4.6: el modo usuario médico y el modo usuario enfermera deben poder enviar mensajes de textos o sonido comprimido en 32kbps (mp3).
	\begin{itemize}
	\item Verificación: se ensaya el envío de mensajes en un entorno controlado(dentro del laboratorio).
	\item Validación:  se realiza la acción en los dispositivos de los colaboradores en un entorno real de uso.
	\end{itemize}		
...
\item Req 6.2: el sistema debe integrar el funcionamiento del servidor con base de datos , aplicación web y aplicaciones moviles.
	...
	\item Validación: se instala en dispositivos de colaboradores y se realiza un ejemplo de uso real del sistema en una entidad hospitalaria.
	\end{itemize}		
