...
\item Como sistema quiero que la aplicación móvil me muestre el estado de las habitaciones. (1 punto)
...
\item Investigación preliminar (60 hs).
	...
	\end{enumerate}
\item Implementación del servidor web(110 hs).
	\begin{enumerate}
	\item Instalación y configuración de Node.Js(30 hs).
	\item Instalación del broker MQTT (40 hs).
	\item Programación de funciones de consulta para aplicación web /móvil (40 hs).
...
\item Implementación de la base de datos (110 horas).
	...
	\item Creación y carga de datos ficticios para pruebas (40 horas).
...
\item Implementación de aplicación enfermera (140 horas).
	\begin{enumerate}
	\item Programación de interfaz de login de usuarios (4 hs).
	\item Programación de lógica y acceso de seguridad de usuarios (10 hs).
	\item Programación de interfaz de usuario modo enfermera (10 hs).
	\item Programación de interfaz de usuario modo médico (10 hs).
	\item Programación de interfae de usuario modo sistema (10 hs).
	...
	\item Programación de funciones de endpoint de la base de datos modo enfermera (10 hs).
...
\begin{figure}[htpb]
\centering 
\includegraphics[width=.8\textwidth]{./Figuras/coloresAON.png}
