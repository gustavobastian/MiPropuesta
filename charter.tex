...
\begin{itemize}
	...
	\item Desarrollo local de una aplicación cliente sistema que asigna enfermeras a pacientes adecuado a la indicación de un médico. Por ejemplo, todos los días a las 17 hs, medir la presión arterial del paciente ``x", independientemente de la enferemera. Esta aplicación permite monitorizar el estado de las habitaciones.
...
\begin{enumerate}
	...
	\item Requerimientos funcionales aplicación web de configuración
		...
		\item La aplicación web debe ser permitir visualización de estadísticas de pacientes o enfermeras, etc.
...
Complejidad: media(3) $\Rightarrow$ tarea se resuelve desde el servidor.

Riesgo: bajo(1) $\Rightarrow$ es una tarea normal en sistemas que mantienen información sobre su estado.
...
Riesgo: bajo(1)$\Rightarrow$ es una tarea normal en sistemas que mantienen información de estado.
...
Dificultad: alta(5) $\Rightarrow$ se debe chequear la disponibilidad de otro enfermero para ayudarlo, derivarlo a otro en caso contrario. Muchas opciones de mensajes y muchos test.
